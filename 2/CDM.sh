...
# Copyrght (C) 1996-2007 Wiley publishing Inc.

# This program isfree software;you can redistribute it and/or modify it.
# under the terms of the GUN General Public License as published by the
...
# You should have received a copy of the GNU Geral Public License along
...
add_record_tracks() {
  echo "Enter track inforation for this CD"
